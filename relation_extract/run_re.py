...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    predict_examples = processor.get_test_examples(FLAGS.test_dir)
    ...
    predict_file = os.path.join(FLAGS.test_dir, "predict.tf_record")
    ...
    output_predict_file = os.path.join(FLAGS.test_dir, "test_results.tsv")
